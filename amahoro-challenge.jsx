    ...
    <div style={{ minHeight: "100vh", background: COLORS.night, color: COLORS.text, fontFamily: "DM Sans,sans-serif", overflowX: "hidden" }}>
      ...
      <div style={{ padding: "5rem 5%", background: COLORS.deep }}>
        ...
        <div style={{ marginTop: 32, display: "flex", gap: 12, flexWrap: "wrap" }}>
          <a href="https://wa.me/250780000000?text=JOIN%20Amahoro%20Challenge" target="_blank" rel="noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: 8, background: COLORS.green, border: "none", color: "#000", fontFamily: "Sora,sans-serif", fontWeight: 700, fontSize: "0.95rem", padding: "12px 24px", borderRadius: 8, textDecoration: "none" }}>
            💬 Join via WhatsApp
          </a>
            ...
            <div style={{ background: COLORS.card, border: `1px solid ${COLORS.border}`, borderRadius: 16, overflow: "hidden" }}>
              ...
              <div style={{ padding: "24px" }}>
                ...
                <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                  ...
                  {reflection.trim() && (
                    <a href={`https://wa.me/250780000000?text=${waMessage}`} target="_blank" rel="noreferrer"
                ...
                {currentDay === 20 && isCompleted && (
                  <div className="fade-in" style={{ marginTop: 24, background: "rgba(37,211,102,0.06)", border: "1px solid rgba(37,211,102,0.25)", borderRadius: 12, padding: "24px", textAlign: "center" }}>
                    ...
                    <div style={{ display: "flex", gap: 10, justifyContent: "center", flexWrap: "wrap" }}>
                      <a href={`https://wa.me/250780000000?text=I%20just%20completed%20the%20Amahoro%2021-Day%20Challenge%21%20%F0%9F%8F%86%20My%20name%20is%20${user.name}%20from%20${user.country}.`} target="_blank" rel="noreferrer"
        ...
        {view === "whatsapp" && (
          <div className="fade-in">
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(280px,1fr))", gap: 16 }}>
              {[
                { icon: "🌅", title: "Daily Challenge on WhatsApp", desc: "Get your daily challenge at 7am every morning as a WhatsApp message from Amara.", link: `https://wa.me/250780000000?text=START%20${encodeURIComponent(user.name)}`, label: "Subscribe to Daily Messages" },
                { icon: "💬", title: "Share Today's Reflection", desc: "Send your Day " + (currentDay + 1) + " reflection directly to Amara on WhatsApp for personalised feedback.", link: `https://wa.me/250780000000?text=Day%20${ch.day}%20reflection:%20`, label: "Send Reflection to Amara" },
                { icon: "👥", title: "Join Your Cohort Group", desc: "Join 20 other African youth going through the challenge together. Accountability. Community. Support.", link: `https://wa.me/250780000000?text=JOIN%20COHORT%20${encodeURIComponent(user.country)}`, label: "Join Cohort Group" },
                { icon: "📊", title: "Get Your Weekly Report", desc: "Ask Amara for your weekly anxiety score update and personalised insight.", link: `https://wa.me/250780000000?text=REPORT%20${encodeURIComponent(user.name)}`, label: "Request Weekly Report" },
              ].map(item => (
    ...
    <div style={{ minHeight: "100vh", background: COLORS.night, display: "flex", flexDirection: "column", fontFamily: "DM Sans,sans-serif", color: COLORS.text }}>
      ...
      <div style={{ background: COLORS.deep, borderBottom: `1px solid ${COLORS.border}`, padding: "0 4%", height: 66, display: "flex", alignItems: "center", gap: 14, flexShrink: 0 }}>
        ...
        <div style={{ marginLeft: "auto" }}>
          <a href={`https://wa.me/250780000000?text=Hi%20Amara!`} target="_blank" rel="noreferrer" style={{ display: "flex", alignItems: "center", gap: 6, background: COLORS.green, border: "none", color: "#000", fontFamily: "Sora,sans-serif", fontWeight: 700, fontSize: "0.8rem", padding: "7px 14px", borderRadius: 8, textDecoration: "none" }}>
