...
const PROXY_URL = "https://beneficial-stillness-production-6f32.up.railway.app";
...
async function callClaude(system, userMsg) {
  ...
  console.log("callClaude response:", JSON.stringify(data).slice(0,200));
  ...
  const send = useCallback(async () => {
    ...
    try {
      ...
      const res = await fetch(`${PROXY_URL}/chat`, {
        method:"POST",
        headers:{ "Content-Type":"application/json" },
        body:JSON.stringify({ system, messages:next.slice(-10) })
      });
      const data = await res.json();
      console.log("Proxy response:", JSON.stringify(data).slice(0,200));
