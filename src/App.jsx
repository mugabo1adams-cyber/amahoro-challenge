              ...
              <div style={{ padding:"24px" }}>
                ...
                <div style={{ background:C.deep, border:`1px solid ${C.border}`, borderRadius:10, padding:"16px", marginBottom:20 }}>
                  ...
                  <textarea value={reflection} onChange={e => setReflection(e.target.value)}
                    ...
                    placeholder={ch.placeholder + " (Press Enter to send)"}
                    rows={5} style={{ width:"100%", background:"transparent", border:"none", color:C.text, fontFamily:"DM Sans,sans-serif", fontSize:"0.93rem", resize:"none", lineHeight:1.65, outline:"none" }} />
                </div>
...
function AmahoroLoader() {
  ...
  return (
    <div style={{ minHeight:"100vh", background:"#0D1117", display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", padding:"2rem", fontFamily:"DM Sans,sans-serif" }}>
      ...
      <img src="/mahoro-avatar.png" alt="" style={{ width:64, height:64, borderRadius:"50%", marginBottom:32, animation:"pulse-load 2s ease-in-out infinite", objectFit:"cover" }} />

      <div className="quote-fade" key={idx} style={{ textAlign:"center", maxWidth:480 }}>
        <div style={{ fontSize:"1.15rem", fontFamily:"Sora,sans-serif", fontWeight:600, color:"#E8EDF2", lineHeight:1.6, marginBottom:12, fontStyle:"italic" }}>
          "{q.quote}"
        </div>
        <div style={{ fontSize:"0.82rem", color:"#25D366", fontFamily:"Sora,sans-serif", fontWeight:700, marginBottom:6 }}>
          — {q.source}
        </div>
        <div style={{ fontSize:"0.8rem", color:"#7A8FA6", lineHeight:1.5 }}>
          {q.meaning}
        </div>
      </div>
      ...
      <div style={{ marginTop:48, display:"flex", gap:6 }}>
        {[0,1,2].map(i => (
          <div key={i} style={{ width:6, height:6, borderRadius:"50%", background:"#25D366", animation:`pulse-load 1.2s ease-in-out infinite ${i*0.2}s` }} />
        ))}
      </div>
    </div>
  );
