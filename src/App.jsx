...
function CoachScreen({ user, onBack, isPro, isOrg }) {
  ...
  const send = useCallback(async () => {
    ...
    try {
      ...
      const data = await res.json();
      setMessages(m => [...m, { role:"assistant", content:data.content?.[0]?.text||"Tell me more — I am here. 🌿" }]);
    } catch {
      setMessages(m => [...m, { role:"assistant", content:"Something went wrong on my end — but I am still here. Tell me what you were sharing. 🌿" }]);
    }
    setLoading(false);
