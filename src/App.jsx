          ...
          <div className="fade-in">
            ...
            <div style={{ background:C.card, border:`1px solid ${C.border}`, borderRadius:14, padding:"22px" }}>
              ...
              <div style={{ display:"flex", gap:8, marginBottom:14 }}>
                ...
                >
                  $290/year <span style={{ opacity:0.75, fontWeight:400 }}>(save $58)</span>
                </button>
              </div>
              ...
              >
                {activating ? "Redirecting to checkout..." : `Subscribe — ${billingCycle==="monthly" ? "$29/mo" : "$290/yr"}`}
              </button>
      ...
      <div style={{ padding:"5rem 5%" }}>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(250px,1fr))", gap:16, maxWidth:860, margin:"0 auto" }}>
          {[
            ...
            { name:"Organizations", price:"$29", sub:"/ month (or $290/yr)", desc:"For schools, NGOs and youth groups.", featured:false, features:["Everything in Pro","Workshop plan","Group progress report","Staff onboarding guide","Up to 30 participants"], btnLabel:"Get for My Organization", btnAction:onPro, btnStyle:"sky" },
          ].map(p => (
