...
const CHALLENGES = [
  {
    ...
    context: "In our culture, we are taught to stay strong and not talk about our struggles. But when you name what you feel, it becomes smaller. This is your first brave step.",
  ...
  },
  {
    ...
    context: "When bad news comes, when things go wrong, your body panics. This breathing exercise, done every day, helps your body calm down. It is free. It works anywhere.",
  ...
  },
  {
    ...
    context: "Worry tells you the worst story. 'I will fail.' 'I am not good enough.' Today you write a better, more honest story back.",
  ...
  },
  {
    ...
    context: "Worry lives in your body too. Tight shoulders. Heavy chest. Stomach pain. Most of us do not notice until it gets bad. Today you pay attention.",
  ...
  },
  {
    ...
    context: "When we keep things inside, they grow bigger. Today you share just one thing — not everything, just one. Someone else in this group is carrying something very similar.",
  ...
  },
  {
    ...
    context: "A lot of our stress comes from chasing goals that are not really ours — our parents' dreams, what society expects. Today you go back to what truly matters to you.",
  ...
  },
  {
    ...
    context: "Your brain notices problems more than good things. This kept our ancestors alive, but today it makes worry worse. Being thankful for small things actually changes how your brain works.",
  ...
  },
  {
    ...
    context: "In our families, saying no feels wrong — especially when people depend on you. But protecting your energy is not selfish. It is how you stay strong enough to help others.",
  ...
  },
  {
    ...
    context: "You have survived every hard day so far. Today you write down the hard things you have already been through. The next time you feel like you cannot cope, this list will remind you that you can.",
    ...
    <div style={{ minHeight: "100vh", background: COLORS.night, color: COLORS.text, fontFamily: "DM Sans,sans-serif", overflowX: "hidden" }}>
      ...
      <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 100, background: "rgba(13,17,23,0.92)", backdropFilter: "blur(12px)", borderBottom: `1px solid ${COLORS.border}`, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 5%", height: 64 }}>
        ...
        <div style={{ display: "flex", gap: 12 }}>
          <button onClick={onCoach} style={{ background: "transparent", border: `1px solid ${COLORS.border}`, color: COLORS.muted, borderRadius: 6, padding: "7px 16px", cursor: "pointer", fontSize: 13, fontFamily: "Sora,sans-serif", fontWeight: 600 }}>Ask Mahoro</button>
      ...
      <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", padding: "7rem 5% 4rem", position: "relative", overflow: "hidden" }}>
        ...
        <h1 className="hero-in-2" style={{ fontFamily: "Sora,sans-serif", fontSize: "clamp(2.2rem,6vw,4.2rem)", fontWeight: 800, lineHeight: 1.1, letterSpacing: "-0.03em", marginBottom: 20, maxWidth: 820 }}>
          Feel better.<br />
          <span style={{ color: COLORS.green }}>21 days.</span> Small steps.<br />
      ...
      <div style={{ padding: "5rem 5%", background: COLORS.deep }}>
        ...
        <p style={{ color: COLORS.muted, fontSize: "1rem", maxWidth: 580, marginBottom: 40, lineHeight: 1.7 }}>"Just pray about it." "You think too much." But the pressure is real. And most of us carry it alone.</p>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(260px,1fr))", gap: 14 }}>
          {[
            { icon: "📚", title: "Academic Pressure", desc: "Exams. Scholarships. Being the first in your family to graduate. The pressure is heavy and there is nowhere to talk about it.", tag: "Very Common", tc: "red" },
            { icon: "💼", title: "Job Market Stress", desc: "Jobs are hard to find. Every rejection hurts more when your family is counting on you.", tag: "Widespread", tc: "amber" },
            { icon: "🏠", title: "Family Obligations", desc: "As the firstborn, you carry everyone. School fees. Bills. Expectations. All before you are 25.", tag: "Very Common", tc: "red" },
            { icon: "📱", title: "Social Media Comparison", desc: "You see others doing well online and wonder why you are behind. But you are only seeing their highlight, not their struggle.", tag: "Growing Fast", tc: "amber" },
            { icon: "🏥", title: "No Access to Therapy", desc: "Seeing a therapist costs too much for most of us. Help should not be a luxury.", tag: "Critical Gap", tc: "red" },
            { icon: "🗣️", title: "Cultural Silence", desc: ""Strong people do not cry." There are no words for how you feel that do not sound like complaining.", tag: "Being Broken", tc: "sky" },
          ].map(c => (
      ...
      <div style={{ padding: "5rem 5%" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(200px,1fr))", gap: 14 }}>
          {[
            { icon: "🌅", time: "Morning · 2 min", title: "Daily Challenge Drop", desc: "Each morning you get one small task. It is simple, short and made for your life." },
            { icon: "✍️", time: "Anytime · 3 min", title: "Reflection Prompt", desc: "Answer one question about your day or how you are feeling. No long essays. Just your honest words." },
            { icon: "🤖", time: "Instant", title: "AI Coach Feedback", desc: "Mahoro replies with culturally-grounded encouragement and a science-backed tip — in seconds." },
            { icon: "👥", time: "Daily", title: "Peer Accountability", desc: "Share your wins or your hard days with others going through the same thing. You are not alone." },
            { icon: "🏆", time: "Day 21", title: "Certificate + Toolkit", desc: "See how much you have grown. Get a certificate. Keep your personal toolkit for life." },
          ].map(s => (
      ...
      <div style={{ padding: "5rem 5%", background: COLORS.deep }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(240px,1fr))", gap: 14 }}>
          {[
            ...
            { icon: "🤖", title: "AI Coach Replies", desc: "Reply with your reflection. Mahoro responds within seconds with personalised, culturally-aware guidance." },
            { icon: "👥", title: "Peer Cohort Groups", desc: "Join 20 youth from your country. Real accountability, real community, zero judgment." },
            { icon: "📊", title: "Weekly Progress", desc: "Every Sunday: your anxiety score improvement, completed challenges, and a personal insight from Mahoro." },
          ].map(f => (
      ...
      <div style={{ padding: "5rem 5%" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(250px,1fr))", gap: 16, maxWidth: 860, margin: "0 auto" }}>
          {[
            { name: "Free", price: "$0", sub: "/ forever", desc: "The full 21-day program. No card needed. No tricks.", featured: false, features: ["21-day core challenge", "Daily WhatsApp messages", "AI coach (5 replies/day)", "Peer cohort group access", "Completion certificate"], missing: ["Advanced workbooks", "Unlimited AI coach"], btnLabel: "Start Free Challenge", btnStyle: "outline" },
            { name: "Amahoro Pro", price: "$4", sub: "/ month", desc: "Everything in Free plus unlimited coaching and extra tools.", featured: true, features: ["Everything in Free", "Unlimited AI coach", "Full workbook library (PDF)", "Monthly anxiety tracking", "Offline audio meditations", "Repeat challenge themes"], missing: [], btnLabel: "Get Amahoro Pro", btnStyle: "green" },
            { name: "Organizations", price: "$29", sub: "/ month", desc: "For schools, organizations and youth groups.", featured: false, features: ["50 participant accounts", "Admin dashboard", "Cohort analytics", "Custom branding", "Monthly group workshop", "2× human coach sessions"], missing: [], btnLabel: "Get for My Organization", btnStyle: "sky" },
          ].map(p => (
            <div key={p.name} style={{ background: COLORS.card, border: `2px solid ${p.featured ? COLORS.green : COLORS.border}`, borderRadius: 16, padding: "28px 24px", position: "relative", boxShadow: p.featured ? `0 0 0 1px rgba(37,211,102,0.2), 0 20px 40px rgba(37,211,102,0.07)` : "none" }}>
              ...
              <button onClick={() => {
                if (p.btnStyle === "outline") { onStart(); return; }
                if (p.name === "Amahoro Pro") { onPro(); return; }
                if (p.name === "Organizations") { onPro(); return; }
      ...
      <div style={{ padding: "5rem 5%", background: COLORS.deep }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(270px,1fr))", gap: 14 }}>
          {[
            { flag: "🇷🇼", name: "Clarisse M.", loc: "Kigali, Rwanda · University student", quote: "I've been carrying exam anxiety since S3. By Day 14, I started sleeping again. Mahoro said something on Day 3 that I've kept as my phone wallpaper since." },
      ...
      <div style={{ padding: "5rem 5%", textAlign: "center" }}>
        ...
        <p style={{ color: COLORS.muted, fontSize: "1rem", maxWidth: 420, margin: "0 auto 32px", lineHeight: 1.7 }}>5 minutes a day. 21 days. A coach who understands you. People who get it. Free to start.</p>
...
function OnboardingScreen({ onComplete }) {
  ...
  const countries = ["Rwanda", "Kenya", "Nigeria", "Uganda", "Tanzania", "Ghana", "Ethiopia", "South Africa", "Cameroon", "Côte d'Ivoire", "DRC / Congo", "Senegal", "Burkina Faso", "Other"];
    ...
    try {
      const res = await fetch("https://api.anthropic.com/v1/messages", {
        ...
        body: JSON.stringify({
          ...
          max_tokens: 1000,
          system: `You are Mahoro, an AI anxiety coach built for African youth from sub-Saharan Africa. You are warm, direct, and culturally grounded. You deeply understand: firstborn responsibilities, academic pressure in African school systems (national exams, KCSE, WAEC, national competitions), job scarcity, family expectations, stigma around mental health, and limited access to professional help. IMPORTANT LANGUAGE RULE: Detect the language the user is writing in and always respond in that same language. If they write in French, respond in French. If they write in Swahili, respond in Swahili. If they write in Kinyarwanda, respond in Kinyarwanda. If they write in English, respond in English. Never switch languages unless the user does first. Reference African realities naturally when relevant (matatu, ugali, jollof, ibirayi, isoko, etc.). Provide practical, science-backed encouragement grounded in CBT and mindfulness. Never use clinical jargon without explanation. Never be dismissive. Keep responses to 3-5 sentences — concise, warm, specific to what they shared. Do not use bullet points. Address the person by name if provided. Always use very simple English — short words, short sentences. Write like you are talking to a friend, not writing a report. Avoid difficult vocabulary.`,
          messages: [{
            role: "user",
  ...
  return (
    <div style={{ minHeight: "100vh", background: COLORS.night, fontFamily: "DM Sans,sans-serif", color: COLORS.text }}>
      ...
      <div style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 100, background: "rgba(13,17,23,0.95)", backdropFilter: "blur(12px)", borderBottom: `1px solid ${COLORS.border}`, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 4%", height: 60 }}>
        ...
        {isPro && <span style={{ background: "rgba(37,211,102,0.15)", border: "1px solid rgba(37,211,102,0.3)", color: COLORS.green, fontSize: "0.68rem", fontFamily: "Sora,sans-serif", fontWeight: 700, padding: "2px 8px", borderRadius: 100 }}>{isOrg ? "ORG" : "PRO"}</span>}
              ...
              <div style={{ padding: "24px" }}>
                ...
                <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                  <button onClick={completeDay} disabled={!reflection.trim() || loading}
                    ...
                    {loading ? "Mahoro is reading..." : "✉️ Get Mahoro's Feedback"}
                  </button>
                  {reflection.trim() && (
                  ...
                  {!isPro && <button onClick={onUpgrade} style={{ background: "transparent", border: `1px solid ${COLORS.amber}`, color: COLORS.amber, fontFamily: "Sora,sans-serif", fontWeight: 600, fontSize: "0.9rem", padding: "11px 18px", borderRadius: 8, cursor: "pointer" }}>⭐ Go Pro</button>}
                  {isPro && <button onClick={onUpgrade} style={{ background: "transparent", border: `1px solid ${COLORS.green}`, color: COLORS.green, fontFamily: "Sora,sans-serif", fontWeight: 600, fontSize: "0.9rem", padding: "11px 18px", borderRadius: 8, cursor: "pointer" }}>🌿 Pro Tools</button>}
                </div>
                ...
                {tipVisible && (
                  <div className="fade-in" style={{ background: "rgba(37,211,102,0.05)", border: "1px solid rgba(37,211,102,0.2)", borderRadius: 12, padding: "18px 18px", marginTop: 20 }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
                      ...
                      <div>
                        <div style={{ fontFamily: "Sora,sans-serif", fontWeight: 700, fontSize: "0.88rem", color: COLORS.green }}>Mahoro</div>
        ...
        {view === "whatsapp" && (
          <div className="fade-in">
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(280px,1fr))", gap: 16 }}>
              {[
                { icon: "🌅", title: "Daily Challenge on WhatsApp", desc: "Get your daily challenge at 7am every morning as a WhatsApp message from Mahoro.", link: `https://wa.me/254113445647?text=START%20${encodeURIComponent(user.name)}`, label: "Subscribe to Daily Messages" },
                { icon: "💬", title: "Share Today's Reflection", desc: "Send your Day " + (currentDay + 1) + " reflection directly to Mahoro on WhatsApp for personalised feedback.", link: `https://wa.me/254113445647?text=Day%20${ch.day}%20reflection:%20`, label: "Send Reflection to Mahoro" },
                ...
                { icon: "📊", title: "Get Your Weekly Report", desc: "Ask Mahoro for your weekly anxiety score update and personalised insight.", link: `https://wa.me/254113445647?text=REPORT%20${encodeURIComponent(user.name)}`, label: "Request Weekly Report" },
              ].map(item => (
            ...
            <div style={{ marginTop: 32, background: COLORS.card, border: `1px solid ${COLORS.border}`, borderRadius: 16, padding: "24px" }}>
              ...
              <div style={{ background: "#0B141A", borderRadius: 12, overflow: "hidden", maxWidth: 400 }}>
                <div style={{ background: "#1F2C34", padding: "12px 16px", display: "flex", alignItems: "center", gap: 10 }}>
                  ...
                  <div>
                    <div style={{ fontFamily: "Sora,sans-serif", fontWeight: 700, fontSize: "0.9rem" }}>Mahoro · Amahoro Coach</div>
...
function CoachScreen({ user, onBack, isPro, isOrg }) {
  const [messages, setMessages] = useState([
    { role: "assistant", content: `Habari${user?.name ? ` ${user.name}` : ""}! I'm Mahoro, your AI wellness coach from Amahoro Challenge. 🌿

I respond in English, Français, Kiswahili and Kinyarwanda — just write in your language and I'll follow.

One honest note: my Kinyarwanda and Swahili are still growing. I understand the heart of what you share, but I may not always capture every local expression perfectly. I am continuously learning and updating to better reflect how we actually speak — the real words, the real culture, the real you.
    ...
    try {
      const res = await fetch("https://api.anthropic.com/v1/messages", {
        ...
        body: JSON.stringify({
          model: "claude-sonnet-4-6",
          max_tokens: 1000,
          system: `You are Mahoro, an AI anxiety coach built specifically for African youth from sub-Saharan Africa. You are warm, direct, deeply empathetic, and culturally grounded. You understand: firstborn responsibilities, academic pressure in African school systems (national exams, KCSE, WAEC, A-levels, university entrance exams), youth unemployment, family expectations of success, stigma around mental health ("just pray about it," "you're thinking too much"), and limited access to professional help. You speak plainly and warmly. IMPORTANT LANGUAGE RULE: Detect the language the user is writing in and always respond in that same language. If they write in French, respond in French. If they write in Swahili, respond in Swahili. If they write in Kinyarwanda, respond in Kinyarwanda. If they write in English, respond in English. Never switch languages unless the user does first. You reference African realities naturally when relevant (matatu, maize, ugali, jollof, ibirayi, isoko, extended family dynamics, etc.). You provide practical, science-backed techniques from CBT and mindfulness. You never use clinical jargon without explaining it. You never minimise someone's struggle. You keep responses to 3–5 sentences — concise, warm, and specific to what the person shared. You do not use bullet points. You always use very simple English — short words, short sentences, easy to understand for someone whose first language is not English. Write like you are talking to a friend. You are not a replacement for professional care, and you gently remind people of this when appropriate.${user ? ` The user's name is ${user.name} from ${user.country}. Their main anxiety trigger is: ${user.trigger}. Their goal: ${user.goal}.` : ""}`,
    ...
    <div style={{ minHeight: "100vh", background: COLORS.night, display: "flex", flexDirection: "column", fontFamily: "DM Sans,sans-serif", color: COLORS.text }}>
      ...
      <div style={{ background: COLORS.deep, borderBottom: `1px solid ${COLORS.border}`, padding: "0 4%", height: 66, display: "flex", alignItems: "center", gap: 14, flexShrink: 0 }}>
        ...
        <div style={{ marginLeft: "auto" }}>
          <a href={`https://wa.me/254113445647?text=Hi%20Mahoro!`} target="_blank" rel="noreferrer" style={{ display: "flex", alignItems: "center", gap: 6, background: COLORS.green, border: "none", color: "#000", fontFamily: "Sora,sans-serif", fontWeight: 700, fontSize: "0.8rem", padding: "7px 14px", borderRadius: 8, textDecoration: "none" }}>
      ...
      <div style={{ background: COLORS.deep, borderTop: `1px solid ${COLORS.border}`, padding: "14px 4%", display: "flex", gap: 10, alignItems: "center" }}>
        <input value={input} onChange={e => setInput(e.target.value)} onKeyDown={e => e.key === "Enter" && send()} placeholder="Ask Mahoro — English, Français, Kiswahili, Kinyarwanda 🌿" style={{ flex: 1, background: COLORS.card, border: `1px solid ${COLORS.border}`, borderRadius: 10, padding: "12px 16px", color: COLORS.text, fontFamily: "DM Sans,sans-serif", fontSize: "0.92rem", transition: "border-color 0.2s" }} />
...
function ProScreen({ user, isPro, isOrg, onActivatePro, onActivateOrg, onBack }) {
    ...
    try {
      const res = await fetch("https://api.anthropic.com/v1/messages", {
        ...
        body: JSON.stringify({
          model: "claude-sonnet-4-6",
          max_tokens: 1000,
          system: system || `You are Mahoro, a warm AI wellness coach for African youth. Use simple, clear English. Short sentences. Easy words. Write like you are talking to a friend.`,
          messages: [{ role: "user", content: prompt }]
        })
      });
      const data = await res.json();
      setOutput(data.content?.[0]?.text || "Something went wrong. Please try again.");
    } catch {
  ...
  const features = {
    workbook: {
      label: "📘 My Personal Workbook",
      desc: "Get a workbook made just for you based on your challenge journey.",
      prompt: `Create a short personal wellness workbook for ${user?.name || "a user"} from ${user?.country || "Africa"}. Their main worry is: ${user?.trigger || "general stress"}. Their goal: ${user?.goal || "feel calmer"}. Format it as a simple workbook with 5 sections. Each section should have a title, 2-3 sentences of explanation, and a short exercise. Use very simple English. Make it warm and encouraging. Make it feel personal to their African context.`,
    },
    meditation: {
      label: "🧘 Meditation for Me",
      desc: "A personal guided meditation written for your life and worries.",
      prompt: `Write a short 5-minute guided meditation for ${user?.name || "someone"} from ${user?.country || "Africa"} who is dealing with ${user?.trigger || "stress and worry"}. Use very simple English. Make it feel warm and grounded in African life. Include breathing, body relaxation, and a positive ending. Write it as if you are speaking directly to them. Use "you" throughout.`,
    },
    progress: {
      label: "📊 My Progress Report",
      desc: "See how far you have come and what to focus on next.",
      prompt: `Write a warm, encouraging monthly progress report for ${user?.name || "a user"} who has been doing the Amahoro 21-day anxiety challenge. They are from ${user?.country || "Africa"}. Their main worry was: ${user?.trigger || "stress"}. Their goal was: ${user?.goal || "feel calmer"}. Write the report in 4 short sections: 1) What you have achieved, 2) What is getting better, 3) What to keep working on, 4) Your next steps. Use simple English. Be warm and specific. End with an encouraging message.`,
    },
    newchallenge: {
      label: "🔄 New Challenge for Me",
      desc: "Get a brand new 7-day challenge made for your specific situation.",
      prompt: `Create a new 7-day wellness challenge for ${user?.name || "someone"} from ${user?.country || "Africa"} whose main struggle is ${user?.trigger || "stress"}. Each day should have: a simple title, one short paragraph of context (2-3 sentences), and one clear task that takes 5 minutes. Make it feel real and relevant to African youth life. Use very simple English. Be warm and practical.`,
    },
  };
  ...
  const orgFeatures = {
    workshop: {
      label: "🏫 Workshop Plan",
      desc: "Get a ready-to-use wellness workshop plan for your group.",
      prompt: `Create a 1-hour wellness workshop plan for ${orgName || "an organization"} with ${teamSize || "a group of"} young people. Topic: ${workshopTopic || "managing stress and anxiety"}. Include: welcome activity (10 min), main learning (30 min), group discussion (15 min), closing reflection (5 min). Use very simple English. Make it practical and interactive. Include what the facilitator should say and do at each stage.`,
    },
    groupreport: {
      label: "📈 Group Progress Report",
      desc: "A summary report you can share with your organization.",
      prompt: `Write a professional but simple group wellness progress report for ${orgName || "an organization"} using the Amahoro Challenge program. Include: program overview, key benefits observed, what participants are learning, recommendations for the next month, and a closing note for leadership. Keep it to one page. Use simple, clear English. Make it feel positive and evidence-based.`,
    },
    onboarding: {
      label: "📋 Staff Onboarding Guide",
      desc: "A simple guide to help your staff introduce Amahoro to participants.",
      prompt: `Write a simple staff onboarding guide for facilitators introducing the Amahoro Challenge to young people at ${orgName || "an organization"}. Include: how to introduce the program (what to say), how to support participants daily, common questions and answers, how to handle someone who is struggling, and how to celebrate completions. Use very simple English. Make it practical and warm.`,
    },
  };
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.night, color: C.text, fontFamily: "DM Sans,sans-serif" }}>
      ...
      <div style={{ background: C.deep, borderBottom: `1px solid ${C.border}`, padding: "0 4%", height: 62, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <div style={{ fontFamily: "Sora,sans-serif", fontWeight: 800, fontSize: "1rem", color: C.green }}>🌿 Amahoro {isPro ? (isOrg ? "Organizations" : "Pro") : "Upgrade"}</div>
        <div style={{ width: 60 }} />
      </div>
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "2rem 4% 5rem" }}>
        ...
        {!isPro && (
          <div className="fade-in">
            <h2 style={{ fontFamily: "Sora,sans-serif", fontWeight: 800, fontSize: "1.6rem", letterSpacing: "-0.02em", marginBottom: 8 }}>Unlock your full plan</h2>
            <p style={{ color: C.muted, marginBottom: 28, lineHeight: 1.7 }}>After paying on Paystack, tick the box below to unlock your features right away. We will verify your payment manually.</p>

            {/* Pro activation */}
            <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: 14, padding: "22px", marginBottom: 16 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 14 }}>
                <div style={{ width: 40, height: 40, borderRadius: 8, background: "rgba(37,211,102,0.15)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "1.2rem" }}>🌿</div>
                <div>
                  <div style={{ fontFamily: "Sora,sans-serif", fontWeight: 700, fontSize: "1rem" }}>Amahoro Pro — $4/month</div>
                  <div style={{ fontSize: "0.82rem", color: C.muted }}>Unlimited coaching · Workbook · Meditation · Progress report · New challenges</div>
                </div>
              </div>
              <label style={{ display: "flex", alignItems: "flex-start", gap: 12, cursor: "pointer" }}>
                <input type="checkbox" checked={checked} onChange={e => setChecked(e.target.checked)}
                  style={{ width: 18, height: 18, marginTop: 2, accentColor: C.green, cursor: "pointer", flexShrink: 0 }} />
                <span style={{ fontSize: "0.9rem", color: C.muted, lineHeight: 1.6 }}>
                  I have paid $4/month for Amahoro Pro on Paystack. I understand my payment will be verified and my access may be removed if payment is not confirmed.
                </span>
              </label>
              <div style={{ display: "flex", gap: 10, marginTop: 14, flexWrap: "wrap" }}>
                <a href="https://paystack.shop/pay/25-4wusw62" target="_blank" rel="noreferrer"
                  style={{ display: "inline-flex", alignItems: "center", gap: 6, background: "transparent", border: `1px solid ${C.green}`, color: C.green, fontFamily: "Sora,sans-serif", fontWeight: 700, fontSize: "0.85rem", padding: "8px 16px", borderRadius: 8, textDecoration: "none" }}>
                  Pay $4/month →
                </a>
                <button onClick={() => { if (checked) { onActivatePro(); setTab("features"); } }}
                  disabled={!checked}
                  style={{ background: checked ? C.green : C.faint, border: "none", color: checked ? "#000" : C.muted, fontFamily: "Sora,sans-serif", fontWeight: 700, fontSize: "0.88rem", padding: "8px 20px", borderRadius: 8, cursor: checked ? "pointer" : "not-allowed" }}>
                  ✓ Activate Pro
                </button>
              </div>
            </div>
            ...
            <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: 14, padding: "22px" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 14 }}>
                <div style={{ width: 40, height: 40, borderRadius: 8, background: "rgba(79,195,247,0.12)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "1.2rem" }}>🏫</div>
                <div>
                  <div style={{ fontFamily: "Sora,sans-serif", fontWeight: 700, fontSize: "1rem" }}>Organizations — $29/month</div>
                  <div style={{ fontSize: "0.82rem", color: C.muted }}>Everything in Pro · Workshop plans · Group reports · Staff onboarding guide</div>
                </div>
              </div>
              <div style={{ marginBottom: 12 }}>
                <input value={orgName} onChange={e => setOrgName(e.target.value)} placeholder="Your organization name"
                  style={{ width: "100%", background: C.deep, border: `1px solid ${C.border}`, borderRadius: 8, padding: "9px 14px", color: C.text, fontFamily: "DM Sans,sans-serif", fontSize: "0.9rem", outline: "none", marginBottom: 8 }} />
              </div>
              <label style={{ display: "flex", alignItems: "flex-start", gap: 12, cursor: "pointer" }}>
                <input type="checkbox" checked={orgChecked} onChange={e => setOrgChecked(e.target.checked)}
                  style={{ width: 18, height: 18, marginTop: 2, accentColor: "#4FC3F7", cursor: "pointer", flexShrink: 0 }} />
                <span style={{ fontSize: "0.9rem", color: C.muted, lineHeight: 1.6 }}>
                  I have paid $29/month for Amahoro Organizations on Paystack. I understand my payment will be verified.
                </span>
              </label>
              <div style={{ display: "flex", gap: 10, marginTop: 14, flexWrap: "wrap" }}>
                <a href="https://paystack.shop/pay/ljxed84arr" target="_blank" rel="noreferrer"
                  style={{ display: "inline-flex", alignItems: "center", gap: 6, background: "transparent", border: "1px solid #4FC3F7", color: "#4FC3F7", fontFamily: "Sora,sans-serif", fontWeight: 700, fontSize: "0.85rem", padding: "8px 16px", borderRadius: 8, textDecoration: "none" }}>
                  Pay $29/month →
                </a>
                <button onClick={() => { if (orgChecked && orgName.trim()) { onActivateOrg(); setTab("features"); } else if (!orgName.trim()) { alert("Please enter your organization name first."); } }}
                  disabled={!orgChecked}
                  style={{ background: orgChecked ? "#4FC3F7" : C.faint, border: "none", color: orgChecked ? "#000" : C.muted, fontFamily: "Sora,sans-serif", fontWeight: 700, fontSize: "0.88rem", padding: "8px 20px", borderRadius: 8, cursor: orgChecked ? "pointer" : "not-allowed" }}>
        ...
        {isPro && (
          <div className="fade-in">
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 6 }}>
              <h2 style={{ fontFamily: "Sora,sans-serif", fontWeight: 800, fontSize: "1.6rem", letterSpacing: "-0.02em" }}>
                {isOrg ? "🏫 Organizations Dashboard" : "🌿 Pro Dashboard"}
              </h2>
              <span style={{ background: "rgba(37,211,102,0.15)", border: "1px solid rgba(37,211,102,0.3)", color: C.green, fontSize: "0.72rem", fontFamily: "Sora,sans-serif", fontWeight: 700, padding: "3px 10px", borderRadius: 100 }}>
                {isOrg ? "ORGANIZATIONS" : "PRO"}
              </span>
            </div>
            <p style={{ color: C.muted, marginBottom: 28, lineHeight: 1.7 }}>
              {isOrg ? `Welcome, ${orgName || "your organization"}. All your tools are ready below.` : `Welcome to Pro, ${user?.name || "warrior"}. All your tools are ready below.`}
            </p>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(300px,1fr))", gap: 12, marginBottom: 24 }}>
              {Object.entries(features).map(([key, feat]) => (
                <div key={key} style={{ background: C.card, border: `1px solid ${activeFeature === key ? C.green : C.border}`, borderRadius: 14, padding: "20px", cursor: "pointer", transition: "border-color 0.2s" }}
                  onClick={() => { setActiveFeature(key); setOutput(""); }}>
                  <div style={{ fontFamily: "Sora,sans-serif", fontWeight: 700, fontSize: "1rem", marginBottom: 4 }}>{feat.label}</div>
                  <div style={{ fontSize: "0.85rem", color: C.muted, lineHeight: 1.6 }}>{feat.desc}</div>
                </div>
              ))}
            </div>
            ...
            {isOrg && (
              <>
                <h3 style={{ fontFamily: "Sora,sans-serif", fontWeight: 700, fontSize: "1rem", color: "#4FC3F7", marginBottom: 12 }}>🏫 Organization Tools</h3>
                <div style={{ marginBottom: 14 }}>
                  <input value={teamSize} onChange={e => setTeamSize(e.target.value)} placeholder="Number of participants (e.g. 25)"
                    style={{ width: "100%", background: C.deep, border: `1px solid ${C.border}`, borderRadius: 8, padding: "9px 14px", color: C.text, fontFamily: "DM Sans,sans-serif", fontSize: "0.9rem", outline: "none", marginBottom: 8 }} />
                  <input value={workshopTopic} onChange={e => setWorkshopTopic(e.target.value)} placeholder="Workshop topic (e.g. exam stress, job anxiety)"
                    style={{ width: "100%", background: C.deep, border: `1px solid ${C.border}`, borderRadius: 8, padding: "9px 14px", color: C.text, fontFamily: "DM Sans,sans-serif", fontSize: "0.9rem", outline: "none" }} />
                </div>
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(300px,1fr))", gap: 12, marginBottom: 24 }}>
                  {Object.entries(orgFeatures).map(([key, feat]) => (
                    <div key={key} style={{ background: C.card, border: `1px solid ${activeFeature === key ? "#4FC3F7" : C.border}`, borderRadius: 14, padding: "20px", cursor: "pointer", transition: "border-color 0.2s" }}
                      onClick={() => { setActiveFeature(key); setOutput(""); }}>
                      <div style={{ fontFamily: "Sora,sans-serif", fontWeight: 700, fontSize: "1rem", marginBottom: 4 }}>{feat.label}</div>
                      <div style={{ fontSize: "0.85rem", color: C.muted, lineHeight: 1.6 }}>{feat.desc}</div>
                    </div>
            ...
            {/* Generate button */}
            {activeFeature && (
              <div className="fade-in" style={{ background: C.deep, border: `1px solid ${C.border}`, borderRadius: 14, padding: "20px", marginBottom: 16 }}>
                <div style={{ fontFamily: "Sora,sans-serif", fontWeight: 700, marginBottom: 8 }}>
                  {(features[activeFeature] || orgFeatures[activeFeature])?.label}
                </div>
                <button onClick={() => {
                  const feat = features[activeFeature] || orgFeatures[activeFeature];
                  callClaude(feat.prompt);
                }}
                  style={{ background: C.green, border: "none", color: "#000", fontFamily: "Sora,sans-serif", fontWeight: 700, fontSize: "0.9rem", padding: "10px 22px", borderRadius: 8, cursor: "pointer", marginBottom: loading || output ? 16 : 0 }}>
                  {loading ? "Mahoro is creating yours..." : "✨ Generate for Me"}
                </button>

                {loading && (
                  <div style={{ display: "flex", gap: 4, alignItems: "center", padding: "8px 0" }}>
                    {[0,1,2].map(i => <div key={i} style={{ width: 7, height: 7, borderRadius: "50%", background: C.green, animation: `pulse 1.2s infinite ${i*0.2}s` }} />)}
                    <span style={{ fontSize: "0.85rem", color: C.muted, marginLeft: 8 }}>Mahoro is writing just for you...</span>
                  </div>
                )}
                ...
                {output && (
                  <div className="fade-in" style={{ background: "rgba(37,211,102,0.04)", border: "1px solid rgba(37,211,102,0.15)", borderRadius: 10, padding: "16px" }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
                      ...
                      <button onClick={() => navigator.clipboard.writeText(output).then(() => alert("Copied to clipboard!"))}
                        style={{ background: "transparent", border: `1px solid ${C.border}`, color: C.muted, fontFamily: "Sora,sans-serif", fontSize: "0.75rem", padding: "4px 12px", borderRadius: 6, cursor: "pointer" }}>
                        Copy
                      </button>
                    </div>
...
export default function App() {
  const [screen, setScreen] = useState("landing"); // landing | onboard | challenge | coach | pro
  ...
  return (
    <>
      {screen === "landing" && <LandingScreen onStart={() => setScreen("onboard")} onCoach={() => setScreen("coach")} onPro={() => setScreen("pro")} isPro={isPro} isOrg={isOrg} />}
      {screen === "onboard" && <OnboardingScreen onComplete={handleOnboardingComplete} />}
      {screen === "challenge" && <ChallengeScreen user={user || { name: "Friend", country: "Africa", trigger: "general stress", goal: "feel calmer" }} onCoach={() => setScreen("coach")} onHome={() => setScreen("landing")} isPro={isPro} isOrg={isOrg} onUpgrade={() => setScreen("pro")} />}
      {screen === "coach" && <CoachScreen user={user} onBack={() => setScreen(user ? "challenge" : "landing")} isPro={isPro} isOrg={isOrg} />}
      {screen === "pro" && <ProScreen user={user} isPro={isPro} isOrg={isOrg} onActivatePro={() => setIsPro(true)} onActivateOrg={() => { setIsOrg(true); setIsPro(true); }} onBack={() => setScreen(user ? "challenge" : "landing")} />}
    </>
  );
}
